...
type SearchReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Comics        []*SearchResult        `protobuf:"bytes,1,rep,name=comics,proto3" json:"comics,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SearchReply) GetComics() []*SearchResult {
	if x != nil {
		return x.Comics
	}
	return nil
...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\x06phrase\x18\x02 \x01(\tR\x06phrase\"0\n" +
	"\fSearchResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\";\n" +
	"\vSearchReply\x12,\n" +
	"\x06comics\x18\x01 \x03(\v2\x14.search.SearchResultR\x06comics2\xb3\x01\n" +
	"\x06Search\x128\n" +
	...
	"\aISearch\x12\x15.search.SearchRequest\x1a\x13.search.SearchReply\"\x00B.Z,github.com/marlendd/XKCD-Search/proto/searchb\x06proto3"
