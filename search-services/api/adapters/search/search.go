...
//go:generate mockgen -destination=../../mocks/mock_search_client.go -package=mocks yadro.com/course/proto/search SearchClient

// только для тестов
func NewClientFromMock(mock searchpb.SearchClient, log *slog.Logger) *Client {
